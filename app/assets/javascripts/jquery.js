...
(function(a, b) {
  ...
  function b$(a, c, d, e, f, g) { f = f || c.dataTypes[0], g = g || {}, g[f] = !0;
    ...
    for(; i < j && (k || !l); i++) l = h[i](c, d, e), typeof l == "string" && (!k || g[l] ? l = b : (c.dataTypes.unshift(l), l = b$(a, c, d, e, l, g)));(k || !l) && !g["*"] && ( l = b$(a, c, d, e, "*", g));
    return l
  }
  ...
  f.extend({
    ...
    queue : function(a, c) { typeof a != "string" && ( c = a, a = "fx");
      if(c === b)
  ...
  try {
    ...
    ajax : function(a, c) {
      ...
      if(!d.hasContent) {d.data && (d.url += (bM.test(d.url) ? "&" : "?") + d.data,
      ...
      return {
        send : function(e, g) {
          ...
          try {
            ...
            var j, k, l, m, n;
            try {
              if(d && (e || h.readyState === 4)) { d = b, i && (h.onreadystatechange = f.noop, cf &&
                delete ch[i]);
                if(e)
